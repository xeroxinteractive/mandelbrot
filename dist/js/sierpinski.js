...
module.exports = function (element) {
  ...
  var sidebarToggle = el.find('[data-action="toggle-sidebar"]');
  var javascriptToggle = el.find('[data-action="toggle-javascript"]');
  var directionToggle = el.find('[data-action="toggle-direction"]');
  var mobileAction = el.find('[data-action="action-mobile"]');
  var tabletAction = el.find('[data-action="action-tablet"]');
  var desktopAction = el.find('[data-action="action-desktop"]');
  ...
  var javascriptState = storage.get('frame.javascript', true);
  var directionState = storage.get('frame.direction', 'ltr');
  var scrollPos = storage.get('frame.scrollPos', 0);
  var previewWidth = storage.get('preview.width', undefined);
  ...
  function toggleJavaScript() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : !javascriptState;
  ...
  javascriptToggle.on('click', function () {
    return toggleJavaScript();
  });

  function toggleDirection() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : directionState === 'rtl' ? 'ltr' : 'rtl';

    var iframe = document.querySelector('.Preview-iframe');
    var iframeHtml = iframe && iframe.contentWindow.document.getElementsByTagName('html')[0];
    if (iframeHtml) {
  ...
  function setFrameWidth(width) {
    ...
    var preview = doc.find('.Preview-wrapper');
    if (preview) {
      previewWidth = width;
      preview.css({
        width: width + 'px',
  ...
  mobileAction.on('click', function () {
    return setFrameWidth(385);
  });

  tabletAction.on('click', function () {
    return setFrameWidth(778);
  });

  desktopAction.on('click', function () {
    return setFrameWidth(1210);
  });
